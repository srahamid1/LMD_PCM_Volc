...
Modified version of the Laboratoire de Météorologie Dynamique (LMD) Generic Planetary Climate Model (PCM) used in Hamid et al. 2024. Based on the LMD Generic subversion revision: 2289.
