...
c       ex : Cerberus lon= 160 and lat= 10.0 (old lon=176.6 and lat=9.0)
...
c     Source flux (kg/s)
       REAL, parameter :: mmsource = 1E7  !Mastin et al. 2009, Glaze and Baloga 2002
      REAL, parameter :: wsource = 1.E7 ! 1wt% magma water content(Greeley 1987)
       REAL, parameter :: h2so4source = 1.E7
c =============================================
c Local variables
c ---------------
...
c       
	...
	WRITE(*,*) 'H2SO4 dropheight', l
	
	ssource(ivolc,l,iq) = h2so4source/massarea(ivolc,l)       
 	WRITE(*,*) 'H2SO4 ssource calculation=', ssource(ivolc,l,iq) 
