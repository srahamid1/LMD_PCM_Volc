      ...
      use tracer_h, only: igcm_h2o_vap, igcm_h2o_ice,igcm_volc_1
      use comcstfi_mod, only: rcp, g, r, cpp
      use callkeys_mod, only: water,tracer,nosurf,callvolcano
      use turb_mod, only : ustar
      use volcano_mod, only : ivolc
...
!                       endif
!                     endif
!                     if (igcm_volc_2.ne.0) then !if you have volcanic ash size 2 as a tracer
!                       if (pqsurf(ig,igcm_volc_2)>=2100) then 
!                       dryness(ig)=0
!                       endif
!                     endif
!                     if (igcm_volc_3.ne.0) then !if you have volcanic ash size 3 as a tracer
!                       if (pqsurf(ig,igcm_volc_3)>=2100) then 
!                       dryness(ig)=0
!                       endif
!                     endif
!                     if (igcm_volc_4.ne.0) then !if you have volcanic ash size 4 as a tracer
!                       if (pqsurf(ig,igcm_volc_4)>=2100) then 
!                       dryness(ig)=0
!                       endif
!                     endif
!                     if (igcm_volc_5.ne.0) then !if you have volcanic ash size 5 as a tracer
!                       if (pqsurf(ig,igcm_volc_5)>=2100) then 
!                       dryness(ig)=0
!                       endif
!                     endif
!                     if (igcm_volc_6.ne.0) then !if you have volcanic ash size 6 as a tracer
!                       if (pqsurf(ig,igcm_volc_6)>=2100) then 
!                       dryness(ig)=0
!                       endif
!                     endif
                  endif
