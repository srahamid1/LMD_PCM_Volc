...
SRCDIR0__phys = /Users/Saira/Documents/GCM/trunk/LMDZ.COMMON/libf/phystd

PPSRCDIR0__phys = /Users/Saira/Documents/GCM/trunk/LMDZ.COMMON/libo/local_112x115x17_phystd_seq.e/.config/ppsrc/phys
...
scatterers 4.h: \
          $(SRCDIR0__phys)/scatterers 4.h
	cp $< $(FCM_INCDIR)
	chmod u+w $(FCM_INCDIR)/$@

scatterers 4.h.idone: \
          $(SRCDIR0__phys)/scatterers 4.h
	touch $(FCM_DONEDIR)/$@
...
scatterers 12.h: \
          $(SRCDIR0__phys)/scatterers 12.h
	cp $< $(FCM_INCDIR)
	chmod u+w $(FCM_INCDIR)/$@

scatterers 12.h.idone: \
          $(SRCDIR0__phys)/scatterers 12.h
	touch $(FCM_DONEDIR)/$@
...
scatterers 7.h: \
          $(SRCDIR0__phys)/scatterers 7.h
	cp $< $(FCM_INCDIR)
	chmod u+w $(FCM_INCDIR)/$@

scatterers 7.h.idone: \
          $(SRCDIR0__phys)/scatterers 7.h
	touch $(FCM_DONEDIR)/$@
...
scatterers 3.h: \
          $(SRCDIR0__phys)/scatterers 3.h
	cp $< $(FCM_INCDIR)
	chmod u+w $(FCM_INCDIR)/$@

scatterers 3.h.idone: \
          $(SRCDIR0__phys)/scatterers 3.h
	touch $(FCM_DONEDIR)/$@
...
scatterers 9.h: \
          $(SRCDIR0__phys)/scatterers 9.h
	cp $< $(FCM_INCDIR)
	chmod u+w $(FCM_INCDIR)/$@

scatterers 9.h.idone: \
          $(SRCDIR0__phys)/scatterers 9.h
	touch $(FCM_DONEDIR)/$@
...
scatterers 15.h: \
          $(SRCDIR0__phys)/scatterers 15.h
	cp $< $(FCM_INCDIR)
	chmod u+w $(FCM_INCDIR)/$@

scatterers 15.h.idone: \
          $(SRCDIR0__phys)/scatterers 15.h
	touch $(FCM_DONEDIR)/$@
...
scatterers 11.h: \
          $(SRCDIR0__phys)/scatterers 11.h
	cp $< $(FCM_INCDIR)
	chmod u+w $(FCM_INCDIR)/$@

scatterers 11.h.idone: \
          $(SRCDIR0__phys)/scatterers 11.h
	touch $(FCM_DONEDIR)/$@
...
scatterers 6.h: \
          $(SRCDIR0__phys)/scatterers 6.h
	cp $< $(FCM_INCDIR)
	chmod u+w $(FCM_INCDIR)/$@

scatterers 6.h.idone: \
          $(SRCDIR0__phys)/scatterers 6.h
	touch $(FCM_DONEDIR)/$@
...
scatterers 8.h: \
          $(SRCDIR0__phys)/scatterers 8.h
	cp $< $(FCM_INCDIR)
	chmod u+w $(FCM_INCDIR)/$@

scatterers 8.h.idone: \
          $(SRCDIR0__phys)/scatterers 8.h
	touch $(FCM_DONEDIR)/$@
...
scatterers 2.h: \
          $(SRCDIR0__phys)/scatterers 2.h
	cp $< $(FCM_INCDIR)
	chmod u+w $(FCM_INCDIR)/$@

scatterers 2.h.idone: \
          $(SRCDIR0__phys)/scatterers 2.h
	touch $(FCM_DONEDIR)/$@
...
scatterers 14.h: \
          $(SRCDIR0__phys)/scatterers 14.h
	cp $< $(FCM_INCDIR)
	chmod u+w $(FCM_INCDIR)/$@

scatterers 14.h.idone: \
          $(SRCDIR0__phys)/scatterers 14.h
	touch $(FCM_DONEDIR)/$@
...
scatterers 10.h: \
          $(SRCDIR0__phys)/scatterers 10.h
	cp $< $(FCM_INCDIR)
	chmod u+w $(FCM_INCDIR)/$@

scatterers 10.h.idone: \
          $(SRCDIR0__phys)/scatterers 10.h
	touch $(FCM_DONEDIR)/$@
...
scatterers 5.h: \
          $(SRCDIR0__phys)/scatterers 5.h
	cp $< $(FCM_INCDIR)
	chmod u+w $(FCM_INCDIR)/$@

scatterers 5.h.idone: \
          $(SRCDIR0__phys)/scatterers 5.h
	touch $(FCM_DONEDIR)/$@
...
scatterers 13.h: \
          $(SRCDIR0__phys)/scatterers 13.h
	cp $< $(FCM_INCDIR)
	chmod u+w $(FCM_INCDIR)/$@

scatterers 13.h.idone: \
          $(SRCDIR0__phys)/scatterers 13.h
	touch $(FCM_DONEDIR)/$@
