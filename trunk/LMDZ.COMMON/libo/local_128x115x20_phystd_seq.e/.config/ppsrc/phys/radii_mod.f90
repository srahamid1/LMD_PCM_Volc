...
!==================================================================
      ...
      use aerosol_mod, only: iaero_back2lay, iaero_co2, iaero_dust, &
                             iaero_h2o, iaero_h2so4, iaero_ash, iaero_nh3, &
		             iaero_aurora
...
!     .def file. To be improved!
            ...
            if(iaer.eq.iaero_h2so4)then ! H2SO4
               reffrad(1:ngrid,1:nlayer,iaer) = 3.e-7
               nueffrad(1:ngrid,1:nlayer,iaer) = 0.1 
            endif

	    if(iaer.eq.iaero_ash)then ! Ash
...
!==================================================================
      ...
      reffrad(1:ngrid,1:nlayer) = 3.e-7 ! h2so4

   end subroutine h2so4_reffrad
!==================================================================

!==================================================================
   subroutine ash_reffrad(ngrid,nlayer,reffrad)
!==================================================================
!     Purpose
!     -------
!     Compute the effective radii of ash particles
!
!     Authors
!     -------
!     Jeremy Leconte (2012)
...
!==================================================================
      ...
      real, intent(out) :: reffrad(ngrid,nlayer)      !Ash particle radii (m)
                
      reffrad(1:ngrid,1:nlayer) = 1.e-6 ! Ash

   end subroutine ash_reffrad
!==================================================================
