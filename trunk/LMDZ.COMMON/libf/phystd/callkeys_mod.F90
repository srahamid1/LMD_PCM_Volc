...
!$OMP THREADPRIVATE(water,watercond,waterrain)
      logical,save :: aeroco2,aeroh2o,aeroh2so4,aeroback2lay,aeroash
!$OMP THREADPRIVATE(aeroco2,aeroh2o,aeroh2so4,aeroback2lay,aeroash)
      logical,save :: aeronh3, aeroaurora
!$OMP THREADPRIVATE(aeronh3,aeroaurora)
      logical,save :: aerofixco2,aerofixh2o,aerofixash
!$OMP THREADPRIVATE(aerofixco2,aerofixh2o,aerofixash)
...
!$OMP THREADPRIVATE(photochem)
      ...
      integer,save :: dropheight
!$OMP THREADPRIVATE(versH2H2cia,iddist,iaervar,iradia,startype,dropheight)
...
!$OMP THREADPRIVATE(tplanckmin,tplanckmax,dtplanck)
      ...
      real,save :: mmsource
      real,save :: wsource
      real,save :: h2so4source
      real,save :: rho_volc
      real,save :: top_h2so4
!$OMP THREADPRIVATE(topdustref,topdust,Nmix_co2,dusttau,Fat1AU,stelTbb,h2so4tau,lon_volc,lat_volc,mmsource,wsource,h2so4source,rho_volc,top_h2so4)
      real,save :: Tstrat
      real,save :: tplanet
